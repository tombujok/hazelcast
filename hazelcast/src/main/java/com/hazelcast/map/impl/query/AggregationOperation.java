...
public class AggregationOperation extends MapOperation implements ReadonlyOperation {
    ...
    public AggregationOperation(String mapName, Predicate predicate, EntryAggregator aggregator) {
        super(mapName);
